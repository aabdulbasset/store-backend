    ...
    userModel.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = 'select firstName,lastName from users where id = ($1)';
                        return [4 /*yield*/, client_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(query, [u.firstName, u.lastName, u.password])];
                    case 2:
                        _a.sent();
                        conn.release();
                        return [2 /*return*/, 1];
